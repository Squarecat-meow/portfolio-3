...
function About() {
  ...
  return (
    ...
    >
      <section />
      <section className="w-full lg:w-2/3 flex flex-col justify-center">
        <p className="text-xs text-slate-400 tracking-[0.5em] mb-4">
          02 - ABOUT
        </p>
        <h1 className="font-hangul-heading text-4xl/tight lg:text-5xl/tight">
          안녕하세요, <br />
          프론트엔드 엔지니어 <br />
          <span className="text-rose-400">정새론</span>입니다.
        </h1>
        <p className="mt-4 text-xs lg:text-lg lg:font-hangul-body break-keep">
          React/Next.js와 Typescript를 중심으로, 작지만 MAU 20명의 질문답변 소셜
          서비스를 비롯한 다양한 프로젝트를 진행했습니다. 어제 1분만에 작동하는
          코드가 오늘 30초만에 작동하도록 노력하며, 서비스를 만듦과 동시에
          운영자이자 직접 사용자가 되어 UX뿐만이 아니라 DX(Developer
          eXperience)까지 증대시키려 노력하고 있습니다.
        </p>
        <section className="mt-2 lg:mt-6 grid grid-cols-4 lg:grid-cols-2">
          <Experience number={1} description="경험 연차" />
          <Experience number={5} description="완성한 프로젝트" />
          <Experience number={20} description="월 평균 사용자" />
          <Experience number={Infinity} description="마신 커피" />
        </section>
        <section>
